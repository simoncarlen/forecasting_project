Summary statistics for the OLS regression are shown in Table \ref{tab:OLS_results}. 
...
\begin{figure}[h]
\centering
\makebox[\textwidth][c]{\includegraphics[width=0.65\textwidth]{../plots/Residual_plots_MLR_PM10}}
